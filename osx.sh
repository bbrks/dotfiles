...
brew cask install atom cathode daisydisk dash docker google-chrome insomnia iterm2 jadengeller-helium sizeup skype spotify spotify-notifications sublime-text texpad the-unarchiver tunnelblick vlc
